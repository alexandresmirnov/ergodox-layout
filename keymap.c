...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_ergodox(
    ...
    MON_SHIFT,OSL(SYMB),KC_X,KC_C,KC_V,KC_B,KC_F12,
    OSM(MOD_LSFT),TG(OVERWATCH),KC_TRNS,KC_TRNS,KC_LGUI,
    ...
    KC_TRNS,KC_N,KC_M,KC_COMMA,KC_DOT,OSL(NUMB),KC_SLASH,
  ...
  [SYMB] = LAYOUT_ergodox(
    ...
    KC_TRNS,TO(BASE),MO(NUMB),KC_LBRACKET,KC_RBRACKET,KC_BSLASH,KC_TRNS,
    ...
    KC_TRNS,KC_AMPR,KC_DOT,KC_COMMA,KC_PLUS,KC_EXLM,KC_TRNS,
    KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
  ...
  [NUMB] = LAYOUT_ergodox(
    ...
    KC_TRNS,KC_TRNS,KC_ESCAPE,KC_TRNS,KC_TRNS,TO(BASE),KC_TRNS,
    KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
